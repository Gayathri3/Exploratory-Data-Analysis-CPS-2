...
This repository is created to fullfill the Module of Data Science Class - Course Project 2.

There is total of 2 data files used to answer 6 questions producing the following files: 

  #6 png pictures 
  #6 scripts to generate each.
